...
begin
  ...
  Jeweler::Tasks.new do |gem|
    ...
    gem.description = %Q{A software model in Ruby for the greenhouse gas emissions of a diet}
    gem.email = "andy@rossmeissl.net"
    gem.homepage = "http://github.com/brighterplanet/diet"
    ...
    gem.add_development_dependency 'sniff', '=0.0.12' unless ENV['LOCAL_SNIFF']
